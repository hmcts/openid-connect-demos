...
public class AuthorizationHeaderUtil {
    ...
    /*
     * What this method is going to do is attempt to get the authorization header
     *
     * If its an access_token, and its valid it will be returned
     *   - If the access_token is expired, it will attempt to refresh it
     *
     * If its a jwt id_token, it will return it as such, as even if it is expired
     * you cannot use it to refresh so the expiration doesn't matter.
     */
    public Optional<String> getAuthorizationHeader() {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();

        // NOTE: this is if the header is an Access Token
        ...
        // NOTE: this is if the header is a Jwt Id Token
